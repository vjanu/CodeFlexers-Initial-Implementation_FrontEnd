...
public class PassengerFragment extends Fragment {
    ...
    private final String JSON_GET_HISTORY_PASSENGER = BASECONTENT.IpAddress+"/trip/history/passenger/";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_passenger_fragment,container,false);
    ...
    private void loadPassengerHistory() {
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_GET_HISTORY_PASSENGER+userId,
