...
import com.example.plusgo.FC.TripHistory.Trip_Details.PassengerHistoryDetailsAdapter;
...
public class AllPassengerHistoryDetailsFragment extends Fragment {
    ...
    public AllPassengerHistoryDetailsFragment() {
    }

    @SuppressLint("ValidFragment")
    public AllPassengerHistoryDetailsFragment(String tripId) {
        this.TripId = tripId;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_all_passenger_history_details_fragment,container,false);
